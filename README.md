...
### BACK
 ...
 #### 1-1. query parameter를 이용한 데이터 호출 및 메뉴 포커스 CSS 기능
 ![카테고리 포커스온](https://user-images.githubusercontent.com/97422072/193229466-71674219-bbf9-46d5-826c-998c3c6e1aa0.gif)
 
 #### 1-2. pagenation 및 sort 기능 구현
 ![limit, sort by 버튼](https://user-images.githubusercontent.com/97422072/193397703-0634cb28-a581-4917-9141-9f703c8d5598.gif)
 
 ### 2. 네비게이션 바 
 
 #### 2-1. 로그인 토큰 값을 기준으로 메뉴 탭 구성이 변경되는 기능 구현
  - 로그인 시 발급되는 토큰 값을 사용해 삼항 연산자로 메뉴탭이 변경되는 기능 구현
  
 #### 2-2. 네브바의 search 메뉴 탭을 클릭하면 검색 모달창이 나오는 기능 구현
  - boolean state값을 기준으로 검색창이 조건부 렌더되도록 구현
 
 #### 2-3. 검색 기능 구현
  - 사용자가 입력한 검색값을 query parameter를 이용해 서버에 보내주고, 응답받은 필터된 데이터 리스트를 화면에 구현
 
 #### 2-4. 장바구니 모달창 css 기능(슬라이드)
 ![모달창 슬라이드](https://user-images.githubusercontent.com/97422072/193397722-d0a05ef6-6079-45d2-8f56-805b9be46ad5.gif)
  
 #### 2-5. 장바구니 모달창 기능 구현
 ![장바구니 수량 조절](https://user-images.githubusercontent.com/97422072/193397748-53d18d2e-7256-40ce-a72f-d9ba21a68c16.gif)
...
<img width="600" src="https://user-images.githubusercontent.com/97422072/181877342-8c063ea9-3554-477b-b2b8-31b9fd5ba3bc.png">

### 2. Slack
- 팀원간의 실시간 소통 창구
<img width="600" src="https://user-images.githubusercontent.com/97422072/181877235-1fb94559-52a4-403c-a3f9-4daf4c8e7b0c.png">

### 3. Notion
 - 회의정리 기록, 오늘의 공유/질문 사항, 현재 진행 사항, blocker 공유, 기능 단위 페이지 셍성 후 공유 및 기록
<img width="600" alt="스크린샷 2022-07-31 오후 1 10 50" src="https://user-images.githubusercontent.com/78889402/182009668-6eae4b48-6a83-4108-8bd5-4804c922e40b.png">
<img width="600" alt="스크린샷 2022-07-31 오후 1 11 13" src="https://user-images.githubusercontent.com/78889402/182009676-f1ad22d5-6cc0-4696-9f16-eeb9fb5e3d80.png">
<img width="600" alt="스크린샷 2022-07-31 오후 1 11 31" src="https://user-images.githubusercontent.com/78889402/182009685-15ed7167-ab01-40f6-9c9e-50b1d0dab04f.png">
<img width="600" alt="스크린샷 2022-07-31 오후 1 11 47" src="https://user-images.githubusercontent.com/78889402/182009689-a6b7a855-8c35-4576-a473-566983dad21a.png"> 
-------
